        ...
        with col2:
            ...
            if summary_option == "Daily Rainfall Summary" and 'filtered_daily' in st.session_state:
                ...
                if plot_type == "Box":
                    ...
                    fig = px.scatter_mapbox(spatial_avg, lat="Latitude", lon="Longitude",
                                            ...
                                            hover_name="AWS_ID", mapbox_style="open-street-map",
                                            color_continuous_scale="Blues",
                                            title="Spatial Distribution of Daily Rainfall")
                st.plotly_chart(fig, use_container_width=True)
            ...
            # EVENTS
                ...
                if plot_type == "Box":
                    ...
                    fig = px.scatter_mapbox(spatial_ev, lat="Latitude", lon="Longitude",
                                            color="Total_Rain", size="Total_Rain",
                                            hover_name="AWS_ID", mapbox_style="open-street-map",
                                            color_continuous_scale="Blues",
                                            title="Spatial Distribution of Rain Events")
                st.plotly_chart(fig, use_container_width=True)
